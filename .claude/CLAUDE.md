# `docs.go-optional` — public documentation repository

This is the **public** documentation site for [`gomatic/go-optional`](https://github.com/gomatic/go-optional), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-optional`](https://github.com/gomatic/go-optional)'s API changes, update [`content/`](../content/) to match.
